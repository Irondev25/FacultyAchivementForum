package com.irondev25.facultyachivementforum.ui.teacherProfile.fragment.workshopEdit.repository;
...
public class WorkshopEditRepository implements Callback<WorkshopObject> {
    private static final String TAG = "WorkshopEditRepository";
    private static final String API_URL = GlobalVars.API_URL;
    private MutableLiveData<WorkshopObject> liveData;
    private ApiInterface apiInterface;

    public WorkshopEditRepository() {
    ...
    public void updateProfileWorkshop(String token, String url,
        ...
        apiInterface.updateProfileWorkshop(auth,url,
                workshopTopicRequestBody,workshopDateRequestBody,workshopTypeRequestBody,workshopLocationRequestBody,certificate)
        .enqueue(this);
    }
