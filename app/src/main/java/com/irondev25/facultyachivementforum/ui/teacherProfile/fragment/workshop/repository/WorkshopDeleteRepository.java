...
public class WorkshopDeleteRepository {
    private static final String TAG = "WorkshopDeleteRepositor";
    private String API_URL = GlobalVars.API_URL;
    private ApiInterface apiInterface;
    private MutableLiveData<ResponseBody> liveData;

    public WorkshopDeleteRepository() {
    ...
    public void deleteProfileWorkshop(String token, String url) {
        ...
        apiInterface.deleteProfileWorkshop(auth,url).enqueue(new Callback<ResponseBody>() {
            @Override
