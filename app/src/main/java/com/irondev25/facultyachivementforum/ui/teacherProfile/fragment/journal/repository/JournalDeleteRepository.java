...
public class JournalDeleteRepository {
    private static final String TAG = "JournalDeleteRepository";
    private String API_URL = GlobalVars.API_URL;
    private ApiInterface apiInterface;
    private MutableLiveData<ResponseBody> liveData;
    
    public JournalDeleteRepository() {
    ...
    public void deleteProfileJournal(String token, String url) {
        ...
        apiInterface.deleteProfileJournal(auth,url).enqueue(new Callback<ResponseBody>() {
            @Override
